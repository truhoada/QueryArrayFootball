...
- (void)viewDidLoad {
    [super viewDidLoad];
    //    NSLog(@"Hello World!");/Users/admin/Desktop/homework Done/QueryArrayManUtd/ObjCExamples/ObjCExamples/QueryArrayMUTeamXI.m
    ...
    NSLog(@"i=%d",i);
        ...
        [self writeln:[NSString stringWithFormat:@"FirstSquad: %d\n",i]];
